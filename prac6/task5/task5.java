...
class SoupBase {
    ...
    // Конструктор для создания основы
...
class PotatoSoup extends Bouillon {
    ...
    public void printIngredients() {
        ...
        System.out.println("Вода: " + water + " л.");
        System.out.println("Соль: " + salt + " г.");
        System.out.println("Масло: " + meat + " г.");
